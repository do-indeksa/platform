...
func configureComplexity(config *Config) {
	...
	config.Complexity.Query.LatestSubmittedDiagnosticRun = func(childComplexity int) int {
	...
	config.Complexity.RunSummary.TaskIds = func(_ int) int {
		return progress.MaxRunItems
	}
