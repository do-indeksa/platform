...
func recoverError(ctx context.Context, _ any) error {
	slog.Error("graphql panic recovered", "request_id", middleware.GetReqID(ctx), "stack", string(debug.Stack()))
	return codedError("INTERNAL", "internal server error")
}
