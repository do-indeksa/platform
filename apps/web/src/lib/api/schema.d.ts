...
export interface paths {
    ...
    "/v1/attempts": {
        ...
        post: operations["recordAttempts"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
...
export interface components {
    ...
    responses: {
        ...
        /** @description Session mutation did not come from the externally visible request origin */
        Forbidden: {
            headers: {
                [name: string]: unknown;
            };
...
export interface operations {
    ...
    recordAttempts: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["NewAttempt"][];
            };
        };
        responses: {
