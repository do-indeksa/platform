...
assert_rejected "empty pull request" pull_request
assert_rejected "unrelated pull request" pull_request README.md
assert_rejected "unsupported event" workflow_dispatch
assert_rejected "missing event"
