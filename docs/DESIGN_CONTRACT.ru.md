...
| `/tasks`, `/tasks/[topic]/[id]`                                                                                           | тот же App Header с единственным task-active indicator                                         | App Header `144:170`, task state `195:168`     |
| `/tasks/[topic]`                                                                                                          | compatibility redirect в `/tasks?topic=[topic]`; отдельного shell нет                          | canonical task-bank route                      |
...
Canonical responsive frames: SR `155:477` / `155:618` / `155:757`, EN
`155:70` / `155:211` / `155:350`, RU `150:2` / `152:30` / `152:584`. В Figma
